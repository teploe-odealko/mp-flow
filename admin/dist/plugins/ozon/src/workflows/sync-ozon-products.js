export async function syncOzonProducts(container, accountId) {
    ...
    for (let i = 0; i < allProductIds.length; i += 100) {
        ...
        const batchDetails = await ozonService.fetchOzonProductInfo({ client_id: account.client_id, api_key: account.api_key }, batch);
...
//# sourceMappingURL=sync-ozon-products.js.map