export async function syncOzonReturns(container, accountId, dateFrom, dateTo) {
    ...
    const returns = await ozonService.fetchOzonReturns({ client_id: account.client_id, api_key: account.api_key }, from, to);
    let updated = 0;
    let skipped = 0;
    let notFound = 0;
...
//# sourceMappingURL=sync-ozon-returns.js.map