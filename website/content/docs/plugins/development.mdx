...
description: Пошаговое руководство по созданию плагина для MPFlow — манифест, frontend, backend, база данных, MCP
---

Плагин MPFlow может добавить **вкладки карточки товара**, **backend API**, **MCP инструменты** — всё из одного манифеста.
