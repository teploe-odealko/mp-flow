...
export class Migration20260301145518 extends Migration {
  ...
  override async up(): Promise<void> {
    // Drop old tables from previous schema (sale_item, sale_fee, sales_channel, sale)
