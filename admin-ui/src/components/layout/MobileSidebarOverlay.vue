  ...
  <Teleport to="body">
    <Transition name="fade">
      ...
      >
        ...
        <!-- Sidebar panel -->
        <aside class="absolute inset-y-0 left-0 w-60 bg-slate-900 text-slate-300 flex flex-col overflow-y-auto shadow-xl">
          <!-- Logo -->
          <div class="flex items-center gap-2.5 px-4 py-5 border-b border-slate-800">
            ...
            <!-- Close button -->
            <button
              class="ml-auto p-1 rounded text-slate-400 hover:text-white"
              @click="uiStore.closeMobileSidebar()"
            >
          ...
          <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            <router-link
              ...
              @click="handleNav"
            >
              <!-- Reuse same icon set as TheSidebar -->
